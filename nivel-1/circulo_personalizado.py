...
class Mi_Circulo(Figura):
    ...
    def __init__(self, fisica, pilas, x=0, y=0, radio=20, dinamica=True,
                 densidad=1.0, restitucion=0.56, friccion=10.5,
                 amortiguacion=0.1, sin_rotacion=False, sensor=False, interactivo=True):
